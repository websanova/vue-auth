...
var __utils = _interopRequireWildcard(require("./lib/utils.js"));

var __token = _interopRequireWildcard(require("./lib/token.js"));

var __cookie = _interopRequireWildcard(require("./lib/cookie.js"));
...
function _processAuthenticated(cb) {
  if (__auth.$vm.authenticated === null && __token.get.call(__auth)) {
...
function plugin(Vue, options) {
  Vue.auth = new _auth["default"](Vue, options);
...
var __utils = _interopRequireWildcard(require("./utils.js"));

var __cookie = _interopRequireWildcard(require("./cookie.js"));

var __storage = _interopRequireWildcard(require("./storage.js"));
...
function processToken(action, key, token, expires) {
  ...
  for (; i < ii; i++) {
    if (ts[i] === 'storage' && __utils.isLocalStorage() && __utils.isSessionStorage()) {
      return __storage[action].apply(this, args);
    }

    if (ts[i] === 'cookie' && __utils.isCookieStorage()) {
...
exports.isCookieStorage = isCookieStorage;
exports.isSessionStorage = isSessionStorage;

function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function isObject(val) {
  if (val !== null && _typeof(val) === 'object' && val.constructor !== Array) {
    return true;
  }
